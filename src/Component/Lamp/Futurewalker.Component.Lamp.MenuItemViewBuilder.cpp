...
auto MenuItemViewBuilder::MakeForMenuView() -> MenuItemViewBuilder
{
    return MenuItemViewBuilder([](MenuItemViewBuilder const&, MenuItem const& item) -> Shared<View> {
        ...
        {
            FW_LOCAL_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(Dp, AttributeStartMargin, [](EdgeInsets const& padding) { return padding.leading; }, MenuItemViewStyle::Padding);
            FW_LOCAL_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(Dp, AttributeEndMargin, [](EdgeInsets const& padding) { return padding.trailing; }, MenuItemViewStyle::Padding);
