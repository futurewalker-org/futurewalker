...
#define FW_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(attribute, func, ...) std::add_const_t<decltype(attribute)> attribute = decltype(attribute)::MakeWithDefaultFunction<__VA_ARGS__>(#attribute, func)
...
#define FW_LOCAL_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(type, attribute, func, ...) static StaticAttribute<type> const attribute = StaticAttribute<type>::MakeWithDefaultFunction<__VA_ARGS__>(#attribute, func)
#else
// For public attribute declarations and definitions.
#define FW_STATIC_ATTRIBUTE(type, attribute) static StaticAttribute<type> const attribute
...
#define FW_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(attribute, func, ...) std::add_const_t<decltype(attribute)> attribute = decltype(attribute)::MakeWithDefaultFunction<__VA_ARGS__>(func)
// For local attribute definitions.
...
#define FW_LOCAL_STATIC_ATTRIBUTE_DEFAULT_FUNCTION(type, attribute, func, ...) static StaticAttribute<type> const attribute = StaticAttribute<type>::MakeWithDefaultFunction<__VA_ARGS__>(func)
#endif
}
}
