...
///
/// @brief Trim end of text range that consists of break characters, and return substring of the trimmed range.
///
...
///
auto StringFunction::StripTrailingBreaks(String const& text, String::IndexType const begin, String::IndexType const end) -> String
{
    auto idx = end;
    while (begin < idx)
    {
