...
auto TextEditPage::Make() -> Shared<TextEditPage>
{
    return View::MakeDerived<TextEditPage>();
}

TextEditPage::TextEditPage(PassKey<View> key)
  : View(key)
{
}

auto TextEditPage::Initialize() -> void
{
