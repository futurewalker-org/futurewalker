...
class UnitTagPx;
class UnitTagPt;
class UnitTagDisplayScale;
class UnitTagBackingScale;
class UnitTagDegree;
class UnitTagRadian;
...
///
using Dp = Float<float64_t, UnitTagDp>;
...
///
using Sp = Float<float64_t, UnitTagSp>;
...
///
using Px = Float<float64_t, UnitTagPx>;

///
/// @brief Integer variant of Dp.
///
using IntDp = Integer<int64_t, UnitTagDp>;

///
/// @brief Integer variant of Sp.
///
using IntSp = Integer<int64_t, UnitTagSp>;

///
/// @brief Integer variant of Px.
///
using IntPx = Integer<int64_t, UnitTagPx>;

///
/// @brief DPI scaling value.
///
using DisplayScale = Float<float64_t, UnitTagDisplayScale>;

///
/// @brief Backing scaling value.
///
using BackingScale = Float<float64_t, UnitTagBackingScale>;

///
/// @brief Degree of angle.
///
using Degree = Float<float64_t, UnitTagDegree>;

///
/// @brief Radian of angle.
///
using Radian = Float<float64_t, UnitTagRadian>;
}
}
