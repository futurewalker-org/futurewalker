...
{
auto PlatformViewLayerVisualPropertyUpdaterWin::PushNode(PlatformViewLayerId const& id, Offset<Dp> const& offset, Rect<Dp> const& clipRect, Float64 const& opacity) -> void
{
...
auto PlatformViewLayerVisualPropertyUpdaterWin::PopNode() -> void
{
    FW_DEBUG_ASSERT(!_nodeStack.empty());
    _nodeStack.pop_back();
}

auto PlatformViewLayerVisualPropertyUpdaterWin::FindNextVisual(PlatformViewLayerId const id) -> Shared<PlatformViewLayerVisualWin>
{
...
auto PlatformViewLayerVisualPropertyUpdaterWin::PushVisual(PlatformViewLayerId const id) -> void
{
...
auto PlatformViewLayerVisualPropertyUpdaterWin::PopVisual() -> void
{
    InternalPopVisualNodeIndex();
    InternalSetCurrentVisual(nullptr);
}

auto PlatformViewLayerVisualPropertyUpdaterWin::GetBaseNodeIndex() const -> SInt64
{
...
auto PlatformViewLayerVisualPropertyUpdaterWin::GetCurrentNodeIndex() const -> SInt64
{
    return static_cast<SInt64>(std::ssize(_nodeStack)) - 1;
}

auto PlatformViewLayerVisualPropertyUpdaterWin::UpdateFragment(Shared<PlatformViewLayerWin> const& layer) -> void
{
    if (!layer)
    {
        FW_DEBUG_ASSERT(false);
...
auto PlatformViewLayerVisualPropertyUpdaterWin::UpdateCore(Shared<PlatformViewLayerWin> const& layer) -> void
{
...
auto PlatformViewLayerVisualPropertyUpdaterWin::Update(Shared<PlatformViewLayerVisualWin> const& visual, Shared<PlatformViewLayerWin> const& layer) -> void
{
    _nodeStack.clear();
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentVisual() -> Shared<PlatformViewLayerVisualWin>
{
    return _currentVisual;
}

auto PlatformViewLayerVisualPropertyUpdaterWin::InternalSetCurrentVisual(Shared<PlatformViewLayerVisualWin> const& visual) -> void
{
    _currentVisual = visual;
}

auto PlatformViewLayerVisualPropertyUpdaterWin::InternalPushVisualNodeIndex() -> void
{
    _visualNodeIndexStack.push_back(std::ssize(_nodeStack) - 1);
}

auto PlatformViewLayerVisualPropertyUpdaterWin::InternalPopVisualNodeIndex() -> void
{
    _visualNodeIndexStack.pop_back();
}

auto PlatformViewLayerVisualPropertyUpdaterWin::InternalResetRelativePropertiesFromBase() -> void
{
    if (!_nodeStack.empty())
    {
        auto& back = _nodeStack.back();
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentOffset() const -> Offset<Dp>
{
    if (!_nodeStack.empty())
    {
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentClipRect() const -> Rect<Dp>
{
    if (!_nodeStack.empty())
    {
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentOpacity() const -> Float64
{
    if (!_nodeStack.empty())
    {
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentOffsetFromBase() const -> Offset<Dp>
{
    if (!_nodeStack.empty())
    {
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentClipRectFromBase() const -> Rect<Dp>
{
    if (!_nodeStack.empty())
    {
...
auto PlatformViewLayerVisualPropertyUpdaterWin::InternalGetCurrentOpacityFromBase() const -> Float64
{
    if (!_nodeStack.empty())
    {
