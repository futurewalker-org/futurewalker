...
auto PlatformViewLayer::NotifyRootBackingScaleChanged(DisplayScale const rootBackingScale) -> void
{
    if (_displayScale != rootBackingScale)
    {
        _displayScale = rootBackingScale;
